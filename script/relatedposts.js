...
function printRelatedLabels_thumbs(e) {
    ...
    var t = Math.floor((relatedTitles.length - 1) * Math.random()),
        r = 0;
    for (relatedTitles.length > 0 && document.write("<header><h4>" + relatedpoststitle + "</h4></header>"), document.write('<ul class="related-posts">'); r < relatedTitles.length && r < 20 && r < maxresults;) document.write('<li class="related-post-item"><div class="related-post-item"><a href="' + relatedUrls[t] + '" class="related-hover"><img src="' + thumburl[t].replace("/s72-c/", "/w300-h170-c/").replace("default.jpg", "sddefault.jpg") + '" class="related-post-thumb" alt="' + relatedTitles[t] + '"></a><div class="related-info"><div class="related-title"><a'), document.write(""), document.write(' href="' + relatedUrls[t] + '">' + relatedTitles[t] + "</a></div></div></div></li>"), r++, t < relatedTitles.length - 1 ? t++ : t = 0;
